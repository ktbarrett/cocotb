...
.. automodule:: cocotb.sim_time
    :members:
    :member-order: bysource
    :synopsis: Various utility functions for dealing with simulation time.
...
.. attribute:: logging.LogRecord.created_sim_time
    ...
    The result of :func:`~cocotb.sim_time.get_sim_time` at the point the log was created
    (in simulator units). The formatter is responsible for converting this
    to something like nanoseconds via :func:`~cocotb.sim_time.get_time_from_sim_steps`.
